...
public class BlockHandler {
	...
	public static int moaPhaserId1 = 601;
	public static int moaPhaserId2 = 602;
	...
	public static void init() {
		...
		moaPhaser1 = new BlockPhaser2(moaPhaserId1).setUnlocalizedName("moaPhaser1");
		GameRegistry.registerBlock(moaPhaser1, "moaPhaser1");
		LanguageRegistry.addName(moaPhaser1, "Medium power Phaser");
		
		moaPhaser2 = new BlockPhaser3(moaPhaserId2).setUnlocalizedName("moaPhaser2");
